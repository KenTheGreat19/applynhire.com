...
/* Merged application script
   Combined from website_design_1.0 + main branch fragments.
   Responsibilities: categories, theme management, job state, map init & helpers, simple rendering + filtering.
*/
